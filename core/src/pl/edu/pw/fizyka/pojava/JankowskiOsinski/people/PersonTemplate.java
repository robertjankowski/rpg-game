...
public abstract class PersonTemplate extends Person {
	...
	// Split to 4 direction of walking
	...
	public PersonTemplate(OrthographicCamera camera, Vector2 pos, String pathToFile) {
		super(pathToFile, pos);
		this.camera = camera;
		walkMusic = new MyMusic(Constants.WALK_MUSIC);
		// animation
		walkSheet = new Texture(Gdx.files.internal(pathToFile));
